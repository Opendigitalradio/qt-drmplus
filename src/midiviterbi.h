#ifndef   _MIDIVITERBI_H
#define   _MIDIVITERBI_H

#include <stdint.h>

extern int ViterbiBitsinByte[];
#ifdef    ONCE
int ViterbiBitsinByte[256] = 
{
...
typedef int (*metriccalculator)(int, int8_t *, int *);
